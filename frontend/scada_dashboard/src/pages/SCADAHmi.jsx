  ...
  return (
    <div className="scada-container">
        ...
        <div className="plc-unit">
          ...
          <div className="registers-grid">
            <div className="register">
              ...
              <div className="register-address">Status: {getStatus(plc1Temp, 'temperature')}</div>
            </div>
            ...
            <div className="register">
              ...
              <div className="register-address">Status: {getStatus(plc1Pressure, 'pressure')}</div>
            </div>
          </div>
        ...
        <div className="plc-unit">
          ...
          <div className="registers-grid">
            <div className="register">
              ...
              <div className="register-address">Status: {getStatus(plc2Flow, 'flow_rate')}</div>
            </div>
            ...
            <div className="register">
              ...
              <div className="register-address">Status: {getStatus(plc2Temp, 'temperature')}</div>
            </div>
          </div>
      ...
      <div className="info-panel">
        📊 <strong>Real-Time Data:</strong> Updates every 2 seconds from Modbus registers.
        Safe ranges: Temperature 170-190°C, Pressure 45-55 PSI, Flow 40-60 L/min.
      </div>
    </div>
  );
}
